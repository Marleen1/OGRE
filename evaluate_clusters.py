...
clusters = json.load(open(dataset+'.clusters_grouped.json','r')) #'/linuxhome/tmp/marleen/Minimap/cluster/limited/until30/minimap_clusterdict_until30_limited.json','r'))
...
read_species_dict = json.load(open(datafolder+'/read_species_dict.json','r'))
